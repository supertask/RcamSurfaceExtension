...
{
    [ExecuteInEditMode]
    sealed class RcamSurface4 : MonoBehaviour
    {
        ...
        //Custom: dissolve shader setting
        [Space]
        [SerializeField, Range(0, 1)] float _dissolvePercentage = 0;
        [SerializeField] Texture _dissolveTex = null;
        [SerializeField, ColorUsage(true,true)] Color _lineColor = new Color(0,0,1,1);
        [SerializeField, Range(0f, 2.0f)] float _lineWidth = 0.25f;
        [SerializeField] Vector4 _dissolveTiling = Vector4.one;
        [SerializeField] Vector4 _dissolveOffset = Vector4.zero;

        public float dissolvePercentage { set { _dissolvePercentage = value; } }
        public Texture dissolveTex { set { _dissolveTex = value; } }
        public Color lineColor { set { _lineColor = value; } }
        public float lineWidth { set { _lineWidth = value; } }
        public Vector4 dissolveTiling { set { _dissolveTiling = value; } }
        public Vector4 dissolveOffset { set { _dissolveOffset = value; } }

        [Space]
        [SerializeField] Texture _wireframeTex = null;
        [SerializeField, ColorUsage(true,true)] Color _wireframeColor = new Color(0,0,1,1);
        [SerializeField] Vector4 _wireframeTiling = Vector4.one;
        [SerializeField] Vector4 _wireframeOffset = Vector4.zero;

        public Texture wireframeTex { set { _wireframeTex = value; } }
        public Color wireframeColor { set { _wireframeColor = value; } }
        public Vector4 wireframeTiling { set { _wireframeTiling = value; } }
        public Vector4 wireframeOffset { set { _wireframeOffset = value; } }
        ...
        void LateUpdate()
        {
            if (_colorMap == null || _positionMap == null || _dissolveTex == null || _wireframeTex == null) return;
            ...
            //Dissolve shader
            _props.SetFloat("_DissolvePercentage", _dissolvePercentage);
            _props.SetTexture("_DissolveTex", _dissolveTex);
            _props.SetVector("_DissolveTiling", _dissolveTiling);
            _props.SetVector("_DissolveOffset", _dissolveOffset);
            _props.SetColor("_LineColor", _lineColor);
            _props.SetFloat("_LineWidth", _lineWidth);

            //Wireframe shader
            _props.SetColor("_WireframeColor", _wireframeColor);
            _props.SetTexture("_WireframeTex", _wireframeTex);
            _props.SetVector("_WireframeTiling", _wireframeTiling);
            _props.SetVector("_WireframeOffset", _wireframeOffset);
